...
from .workflow import WorkflowTask, WorkflowModel
...
class TaskOrderer(ABC):
    ...
    @abstractmethod
    def order(self, tasks: list[WorkflowTask], workflow_model: WorkflowModel, system_model: SystemModel) -> list[WorkflowTask]:
        pass

    @abstractmethod
    def key(self, task: WorkflowTask, workflow_model: WorkflowModel, system_model: SystemModel):
        pass

    def insert(self, waiting, task: WorkflowTask, workflow_model: WorkflowModel, system_model: SystemModel):
